 ...
 *
 * Modified by the Bonfire Team to support multiple locations and
 * Bonfire-specific code.
 *
 * NOTICE OF LICENSE
 *
...
class CI_Migration {
    ...
    //--------------------------------------------------------------------
    // Bonfire-specific Methods
    //--------------------------------------------------------------------

    /**
     * Updates the system to the latest version of the
     * Bonfire core migrations.
     *
     * @return mixed
     */
    public function update_core()
    {
        $this->_migration_path = BFPATH .'migrations/';
    ...
    {
        $this->_migration_path = APPPATH .'database/migrations/';
    ...
    /**
     * Updates the migrations to the latest migration version for
     * a single module.
     *
     * @param $module
     * @return bool|mixed
    ...
    {
        $path = \Bonfire\Modules::path($module, 'migrations');
    ...
    /**
     * Uninstalls and re-installs the changes for the application migrations.
     *
     * @return mixed
     */
    ...
    /**
     * Uninstalls and re-installs the changes for Bonfire core migrations.
     *
     * @return mixed
     */
    public function refresh_core()
    {
        $this->_migration_path = BFPATH .'migrations/';
    ...
    /**
     * Uninstalls and re-installs the changes for a module's migrations.
     *
     * @return mixed
     */
    public function refresh_module($module)
    {
        $path = \Bonfire\Modules::path($module, 'migrations');
